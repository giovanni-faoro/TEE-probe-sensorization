function [omega,quat_derivative,quat_derivative2] = quaternion2AngularVelocityL(quaternion,dt)
    %This function returns the estimated angular velocity in local reference frame from a sequence
    ...
    %formula:           omega(t) = lim_dt->0 2Im((q*(t)q(t+dt))/dt)
    ...
    for i=1:N-1
        ...
        %the first component
        var = (2/dt)*quatmultiply(quatconj(quaternion(:,i)'),quaternion(:,i+1)');
        omega(:,i) = var(2:end);
