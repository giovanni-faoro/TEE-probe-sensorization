function [vector_rot] = quaternionRot(quaternion,vector)
    %This function returns the rotated vector after applying quaternion
    %The rotation is applied with respect to global axis
    ...
    vector_rot = quatmultiply(quaternion',quatmultiply(vector_quat',quatinv(quaternion')))';
